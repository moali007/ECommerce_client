...
function Collection() {
  ...
  async function fetchProducts() {
    ...
    //jab home se explore more wala button dabaenge to saare products dikhne chahie ,ye tab hoga jab koi categoty selected na ho (else wala part above case me)
      ...
      <div className="container">
        <div className="header">
          <div className="info">
            ...
            <p>
              India's largest collection of wall posters for your bed room,
              living room,kitchen
            </p>
          </div>
            ...
            <div className="category-filter">
              ...
              {categories.map((item) => (
                <div key={item.id} className="filter-radio">
                  ...
                  />
                  <label htmlFor="comics">{item.attributes.title}</label>
                </div>
              ))}
            </div>
          </div>
